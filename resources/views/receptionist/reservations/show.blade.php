...
<div class="table-responsive col-lg-12">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                <br> <button type="button" class="btn btn-sm btn-warning mt-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    Update Status
                </button>
            </p>
        </div>
    ...
    <br>
    <a href="{{ route('reservations.index') }}" class="btn btn-danger mb-3">Back</a>
