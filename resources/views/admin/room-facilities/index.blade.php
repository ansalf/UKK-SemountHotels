...
<div class="table-responsive col-lg-12">
    <table class="table table-sm table-bordered table-hover border-dark text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="{{ asset('storage/' . $room_facility->image) }}" alt="Gambar {{ $room_facility->facility_name }}" width="200" height="200" class="img-fluid"></td>
                <td>
    ...
    <div class="text-end">
        <a href="{{ route('room-facilities.create') }}" class="btn btn-primary mb-3">Create New Room Facilities</a>
    </div>
