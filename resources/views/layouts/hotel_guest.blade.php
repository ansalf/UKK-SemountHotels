        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light mt-4">
                <div class="container-fluid">
                    <h1 class="display-5 fw-bold">Seamount</h1>
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item text-nowrap ms-3">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="nav-link px-2 btn btn-outline-secondary mb-1" type="submit" style="border-radius:5px; padding-left: 10px;" onclick="return('Anda yakin ingin keluar?')">Back</button>
                                </form>
                            </li>
                        </ul>
                    </div>
